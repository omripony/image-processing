...
struct s2dPoint
{
	...
	s2dPoint(int x = 0, int y = 0) : X(x), Y(y)
	{
		validate();
	}
...
void blend(unsigned char img_src1[][NUMBER_OF_COLUMNS], unsigned char img_src2[][NUMBER_OF_COLUMNS]
	, unsigned char img_dst[][NUMBER_OF_COLUMNS]);
